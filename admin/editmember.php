...
<form name=form1  method="POST" action="doeditmember.php?tid=<?php echo $r[tid];  ?>">
<table width=98% align=center cellspacing=0 cellpadding=0 class=i_table>
<tr><td><table width=100% cellspacing=1 cellpadding=6>
<tr><td class=head colspan=5><b>编辑会员</b></td></tr>

<tr align=center><td class=b width=30%>会员ID:</td>
<td colspan="3" class=b><input name="tid" type="text" size="100" value="<?php echo $r["tid"];  ?>" /></td></tr>

<tr align=center><td class=b width=30%> 用户名:</td>
<td colspan="3" class=b><input name="username" type="text" size="100" value="<?php echo $r["username"];  ?>" /></td></tr>



<tr align=center><td class=b width=30%>真实姓名:</td>
<td colspan="3" class=b><input name="name" type="text" size="100" value="<?php echo $r["name"];  ?>" /></td></tr>


<tr align=center><td class=b width=30%>手机号:</td>
<td colspan="3" class=b><input name="mobile" type="text" size="100" value="<?php echo $r["mobile"];  ?>" /></td></tr>

<tr align=center><td class=b width=30%>财富值:</td>
<td colspan="3" class=b><input name="caifu" type="text" size="100" value="<?php echo $r["caifu"];  ?>" /></td></tr>
