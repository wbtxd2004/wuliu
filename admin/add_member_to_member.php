...
<form action="doadd_member_to_member.php" method=post name="f" onsubmit="return check()">
<tr class=b>
...
<tr  align=center class=b><td>私信内容：</td><td><textarea rows=10 cols=50 name="info"></textarea>
</td></tr>
