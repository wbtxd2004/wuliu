...
<form action="doedit_member_to_member.php?tid=<?php echo $tid?>" method=post name="f" onsubmit="return check()" enctype="multipart/form-data">
<tr class=b>
  <td class=head colspan=2><b>编辑私信</b></td>
</tr>
<tr align=center class=b><td>发件人ID：</td><td><?php echo $row["send_id"]?></td></tr>
...
<?php
$sql="select * from member_to_member_images where mid='$tid' and filetype='0' ";
...
<?php
$sql="select * from member_to_member_images where mid='$tid' and filetype='1'";
