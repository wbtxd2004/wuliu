...
$query = "select * from member_get_message";
...
echo "<p>";
echo "<a href='add_member_message.php'>创建私信</a>&nbsp;&nbsp;";
...
$query = "select * from member_get_message order by tid    limit $a,$page_size ";
$result = mysql_db_query($DataBase, $query);
...
while($row=mysql_fetch_array($result))
{
	...
	echo "<td><a href='edit_member_message.php?tid=".$row["tid"]."'>编辑</a></td>";
	echo "<td>";
	?>
	<a onClick="if(confirm('您确定删除吗?')) {return true;}else {return false;}"  href="del_member_message.php?tid=<?php echo $row["tid"];?>" class="button"  >删除</a>
	<?php echo "</td>";
	echo "</tr>\n";
}
