...
<form name=form1  method="POST" action="doeditnews_category.php?tid=<?php echo $r[tid];  ?>">
<table width=98% align=center cellspacing=0 cellpadding=0 class=i_table>
<tr><td><table width=100% cellspacing=1 cellpadding=6>
<tr><td class=head colspan=5><b>编辑新闻分类</b></td></tr>

<tr align=center><td class=b width=30%> 新闻名称:</td>
